#!/usr/bin/env python3
"""
Create a working ANN model that will deploy successfully
"""
import pandas as pd
import numpy as np
import joblib
...
def create_working_ann():
    ...
    # Create ANN model with simple architecture
    print("Training ANN model...")
    model = Sequential()
    
    # Add layers one by one to avoid Input layer issues
    ...
    try:
        # Save as H5 format
        model.save('working_ann_model.h5')
    ...
    try:
        ...
        loaded_model = load_model('working_ann_model.h5')
...
if __name__ == "__main__":
    success = create_working_ann()
    if success:
        print("\n🎉 SUCCESS! Your working ANN model is ready!")
    else:
